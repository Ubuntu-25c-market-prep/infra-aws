###############################################################################
# staging environment root - version constraints and state backend.
#
# Environment-based layout under roots/environments/. Staging stays DORMANT
# (ADR 0003) - scaffolded but not applied while only dev is deployed. The
# backend below is ready for the day it is activated.
#
# State key is scoped to the environment (staging/), matching this folder. Same
